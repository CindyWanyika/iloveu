const sr = ScrollReveal({ distance: "50px", origin: "left", duration: 500 });
...
const srRight = ScrollReveal({ distance: "50px", origin: "right", duration: 500 });
